...
const NAV_ITEMS = [
  { id: 'home', label: 'Dashboard', href: '/', icon: DashboardIcon },
  { id: 'dashboard', label: 'Portfolios', href: '/dashboard', icon: PortfoliosIcon },
  { id: 'sectors', label: 'Analytics', href: '/dashboard/sectors', icon: AnalyticsIcon },
  { id: 'health', label: 'Watchlist', href: '/dashboard/health', icon: WatchlistIcon },
  { id: 'chat', label: 'AI Chat', href: '/chat', icon: ChatIcon },
  { id: 'upload', label: 'Settings', href: '/upload', icon: SettingsIcon },
];
