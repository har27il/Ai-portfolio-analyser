...
export function DesktopSidebar({ active }: { active: string }) {
  return (
    <aside className="hidden lg:flex flex-col fixed top-0 left-0 bottom-0 w-[280px] bg-status-bar text-white z-50">
      {/* Logo section */}
      <div className="px-6 pt-6 pb-4 border-b border-white/10">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 bg-card-blue rounded-lg flex items-center justify-center">
